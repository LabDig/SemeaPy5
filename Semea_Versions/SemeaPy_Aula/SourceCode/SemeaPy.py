...
class Semea(QtWidgets.QTabWidget,Ui_SEMEA):
    def __init__(self,parent=None):
        ...
        self.time_start_mach,self.aux_j_mach,self.fertbym,self.seedbym,self.lat,self.long,self.pdop,self.status=0,0,0,0,0,0,0.0,0
        ...
        self.popseed=50000
        self.p_pop.clicked.connect(self.IncreasePop)
        self.m_pop.clicked.connect(self.DecreasePop)
    ...
    def ControlFunction(self):  #Main Loop of Software
        ...
        if GPIO.input(pinOnOffButton):
            ...
            self.seed_germ=int(self.ql_germ.toPlainText())             # Read Germination
            ...
            self.row_spacing=float(self.ql_row_spacing.toPlainText())           #Read Spacing
            ...
            if self.list_seed.currentText()=="FIX": #Fix seed distribuition rate
                ...
                self.lb_status.setText("RS:"+str(self.real_rot_seed)+"..CS:"+str(self.rot_seed))
